...
class CreateNewOutfitAttachments extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    // tslint:disable-next-line:max-line-length
    ['headerData', { quantity: 1, parameters: new Collection<string, any>([['newFolder', Types.UUID]]) }],
    // tslint:disable-next-line:max-line-length
    ['objectData', { parameters: new Collection<string, any>([['oldItem', Types.UUID], ['oldFolder', Types.UUID]]) }]
  ])
