...
class DataHomeLocationRequest extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    ['info', { quantity: 1, parameters: new Collection<string, any>([['agent', Types.UUID], ['kickedFromEstate', Types.U32]]) }],
    // tslint:disable-next-line:max-line-length
    ['agentInfo', { quantity: 1, parameters: new Collection<string, any>([['agentEffectiveMaturity', Types.U32]]) }]
  ])
