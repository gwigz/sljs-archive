...
class ChildAgentUpdate extends Packet {
   ...
   * @param {LLUUID} [data.agentData.preyAgent] PreyAgent
   ...
   * @param {LLUUID} [data.animationData.animation] Animation
   * @param {LLUUID} [data.animationData.object] ObjectID
   * @param {LLUUID} [data.granterBlock.granter] GranterID
