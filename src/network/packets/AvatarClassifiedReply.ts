...
class AvatarClassifiedReply extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    ['agentData', { quantity: 1, parameters: new Collection<string, any>([['agent', Types.UUID], ['target', Types.UUID]]) }],
    // tslint:disable-next-line:max-line-length
    ['data', { parameters: new Collection<string, any>([['classified', Types.UUID], ['name', Types.Variable1]]) }]
  ])
