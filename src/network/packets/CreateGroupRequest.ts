...
class CreateGroupRequest extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    // tslint:disable-next-line:max-line-length
    ['groupData', { quantity: 1, parameters: new Collection<string, any>([['name', Types.Variable1], ['charter', Types.Variable2], ['showInList', Types.Boolean], ['insignia', Types.UUID], ['membershipFee', Types.S32], ['openEnrollment', Types.Boolean], ['allowPublish', Types.Boolean], ['maturePublish', Types.Boolean]]) }]
  ])
