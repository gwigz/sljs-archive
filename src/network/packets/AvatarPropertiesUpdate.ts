...
class AvatarPropertiesUpdate extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    // tslint:disable-next-line:max-line-length
    ['propertiesData', { quantity: 1, parameters: new Collection<string, any>([['image', Types.UUID], ['firstLifeImage', Types.UUID], ['aboutText', Types.Variable2], ['firstLifeAboutText', Types.Variable1], ['allowPublish', Types.Boolean], ['maturePublish', Types.Boolean], ['profileURL', Types.Variable1]]) }]
  ])
