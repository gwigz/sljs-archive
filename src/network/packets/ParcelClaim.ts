...
class ParcelClaim extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    // tslint:disable-next-line:max-line-length
    ['data', { quantity: 1, parameters: new Collection<string, any>([['group', Types.UUID], ['isGroupOwned', Types.Boolean], ['final', Types.Boolean]]) }],
    // tslint:disable-next-line:max-line-length
    ['parcelData', { parameters: new Collection<string, any>([['west', Types.F32], ['south', Types.F32], ['east', Types.F32], ['north', Types.F32]]) }]
  ])
