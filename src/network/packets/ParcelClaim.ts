...
class ParcelClaim extends Packet {
  ...
  public static format: Collection = new Collection([
    ...
    // tslint:disable-next-line:max-line-length
    ['data', { quantity: 1, parameters: new Collection([['group', Types.UUID], ['isGroupOwned', Boolean], ['final', Boolean]]) }],
    // tslint:disable-next-line:max-line-length
    ['parcelData', { parameters: new Collection([['west', Types.F32], ['south', Types.F32], ['east', Types.F32], ['north', Types.F32]]) }]
  ])
