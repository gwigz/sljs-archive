...
class OpenCircuit extends Packet {
   ...
   * @type {number}
   */
  public static id: number = 4294967292
   ...
   * @type {number}
   */
  public static frequency: number = 3
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    ['circuitInfo', { quantity: 1, parameters: new Collection<string, any>([['ip', Types.IP], ['port', Types.Port]]) }]
  ])
