...
class ParcelPropertiesRequest extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    // tslint:disable-next-line:max-line-length
    ['parcelData', { quantity: 1, parameters: new Collection<string, any>([['sequence', Types.S32], ['west', Types.F32], ['south', Types.F32], ['east', Types.F32], ['north', Types.F32], ['snapSelection', Types.Boolean]]) }]
  ])
