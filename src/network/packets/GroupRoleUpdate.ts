...
class GroupRoleUpdate extends Packet {
  ...
  public static format: Collection = new Collection([
    ...
    // tslint:disable-next-line:max-line-length
    ['roleData', { parameters: new Collection([['role', Types.UUID], ['name', Types.Variable1], ['description', Types.Variable1], ['title', Types.Variable1], ['powers', Types.U64], ['updateType', Types.U8]]) }]
  ])
