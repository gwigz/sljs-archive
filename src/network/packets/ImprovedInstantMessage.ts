...
class ImprovedInstantMessage extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    // tslint:disable-next-line:max-line-length
    ['messageBlock', { quantity: 1, parameters: new Collection<string, any>([['fromGroup', Types.Boolean], ['toAgent', Types.UUID], ['parentEstate', Types.U32], ['region', Types.UUID], ['position', Types.Vector3], ['offline', Types.U8], ['dialog', Types.U8], ['id', Types.UUID], ['timestamp', Types.U32], ['fromAgentName', Types.Variable1], ['message', Types.Variable2], ['binaryBucket', Types.Variable2]]) }]
  ])
