...
class ObjectGrabUpdate extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    // tslint:disable-next-line:max-line-length
    ['objectData', { quantity: 1, parameters: new Collection<string, any>([['object', Types.UUID], ['grabOffsetInitial', Types.Vector3], ['grabPosition', Types.Vector3], ['timeSinceLast', Types.U32]]) }],
    // tslint:disable-next-line:max-line-length
