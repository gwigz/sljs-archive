...
class SetFollowCamProperties extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    ['objectData', { quantity: 1, parameters: new Collection<string, any>([['object', Types.UUID]]) }],
    // tslint:disable-next-line:max-line-length
    ['cameraProperty', { parameters: new Collection<string, any>([['type', Types.S32], ['value', Types.F32]]) }]
  ])
