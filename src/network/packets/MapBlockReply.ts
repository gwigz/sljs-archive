...
class MapBlockReply extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    // tslint:disable-next-line:max-line-length
    ['data', { parameters: new Collection<string, any>([['x', Types.U16], ['y', Types.U16], ['name', Types.Variable1], ['access', Types.U8], ['regionFlags', Types.U32], ['waterHeight', Types.U8], ['agents', Types.U8], ['mapImage', Types.UUID]]) }]
  ])
