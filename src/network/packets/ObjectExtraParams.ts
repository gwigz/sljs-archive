...
class ObjectExtraParams extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    // tslint:disable-next-line:max-line-length
    ['objectData', { parameters: new Collection<string, any>([['objectLocal', Types.U32], ['paramType', Types.U16], ['paramInUse', Types.Boolean], ['paramSize', Types.U32], ['paramData', Types.Variable1]]) }]
  ])
