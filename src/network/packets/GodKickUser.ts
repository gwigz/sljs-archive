...
class GodKickUser extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    ['userInfo', { quantity: 1, parameters: new Collection<string, any>([['god', Types.UUID], ['godSession', Types.UUID], ['agent', Types.UUID], ['kickFlags', Types.U32], ['reason', Types.Variable2]]) }]
  ])
