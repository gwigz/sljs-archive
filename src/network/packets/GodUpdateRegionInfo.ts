...
class GodUpdateRegionInfo extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    // tslint:disable-next-line:max-line-length
    ['regionInfo', { quantity: 1, parameters: new Collection<string, any>([['simName', Types.Variable1], ['estate', Types.U32], ['parentEstate', Types.U32], ['regionFlags', Types.U32], ['billableFactor', Types.F32], ['pricePerMeter', Types.S32], ['redirectGridX', Types.S32], ['redirectGridY', Types.S32]]) }]
  ])
