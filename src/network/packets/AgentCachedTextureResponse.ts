...
class AgentCachedTextureResponse extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    ['agentData', { quantity: 1, parameters: new Collection<string, any>([['agent', Types.UUID], ['session', Types.UUID], ['serialNum', Types.S32]]) }],
    // tslint:disable-next-line:max-line-length
    ['wearableData', { parameters: new Collection<string, any>([['texture', Types.UUID], ['textureIndex', Types.U8], ['hostName', Types.Variable1]]) }]
  ])
