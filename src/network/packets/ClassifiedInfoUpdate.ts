...
class ClassifiedInfoUpdate extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    // tslint:disable-next-line:max-line-length
    ['data', { quantity: 1, parameters: new Collection<string, any>([['classified', Types.UUID], ['category', Types.U32], ['name', Types.Variable1], ['desc', Types.Variable2], ['parcel', Types.UUID], ['parentEstate', Types.U32], ['snapshot', Types.UUID], ['posGlobal', Types.Vector3D], ['classifiedFlags', Types.U8], ['priceForListing', Types.S32]]) }]
  ])
