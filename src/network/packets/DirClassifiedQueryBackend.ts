...
class DirClassifiedQueryBackend extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    // tslint:disable-next-line:max-line-length
    ['queryData', { quantity: 1, parameters: new Collection<string, any>([['query', Types.UUID], ['queryText', Types.Variable1], ['queryFlags', Types.U32], ['category', Types.U32], ['estate', Types.U32], ['godlike', Types.Boolean], ['queryStart', Types.S32]]) }]
  ])
