...
class ScriptQuestion extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    ['data', { quantity: 1, parameters: new Collection<string, any>([['task', Types.UUID], ['item', Types.UUID], ['objectName', Types.Variable1], ['objectOwner', Types.Variable1], ['questions', Types.S32]]) }]
  ])
