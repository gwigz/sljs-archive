...
class SetGroupAcceptNotices extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    // tslint:disable-next-line:max-line-length
    ['data', { quantity: 1, parameters: new Collection<string, any>([['group', Types.UUID], ['acceptNotices', Types.Boolean]]) }],
    // tslint:disable-next-line:max-line-length
    ['newData', { quantity: 1, parameters: new Collection<string, any>([['listInProfile', Types.Boolean]]) }]
  ])
