...
class ObjectExportSelected extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    ['agentData', { quantity: 1, parameters: new Collection<string, any>([['agent', Types.UUID], ['request', Types.UUID], ['volumeDetail', Types.S16]]) }],
    // tslint:disable-next-line:max-line-length
    ['objectData', { parameters: new Collection<string, any>([['object', Types.UUID]]) }]
  ])
