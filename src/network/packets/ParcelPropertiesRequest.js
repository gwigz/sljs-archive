...
class ParcelPropertiesRequest extends Packet {
  ...
  static format = new Collection([
    ...
    ['parcelData', { quantity: 1, parameters: new Collection([['sequence', Types.S32], ['west', Types.F32], ['south', Types.F32], ['east', Types.F32], ['north', Types.F32], ['snapSelection', Boolean]]) }]
  ])
