...
class LogTextMessage extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    ['dataBlock', { parameters: new Collection<string, any>([['fromAgentId', Types.UUID], ['toAgentId', Types.UUID], ['globalX', Types.F64], ['globalY', Types.F64], ['time', Types.U32], ['message', Types.Variable2]]) }]
  ])
