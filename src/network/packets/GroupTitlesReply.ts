...
class GroupTitlesReply extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    ['agentData', { quantity: 1, parameters: new Collection<string, any>([['agent', Types.UUID], ['group', Types.UUID], ['request', Types.UUID]]) }],
    // tslint:disable-next-line:max-line-length
    ['groupData', { parameters: new Collection<string, any>([['title', Types.Variable1], ['role', Types.UUID], ['selected', Types.Boolean]]) }]
  ])
