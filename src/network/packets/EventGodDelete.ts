...
class EventGodDelete extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    // tslint:disable-next-line:max-line-length
    ['eventData', { quantity: 1, parameters: new Collection<string, any>([['event', Types.U32]]) }],
    // tslint:disable-next-line:max-line-length
    ['queryData', { quantity: 1, parameters: new Collection<string, any>([['query', Types.UUID], ['queryText', Types.Variable1], ['queryFlags', Types.U32], ['queryStart', Types.S32]]) }]
  ])
