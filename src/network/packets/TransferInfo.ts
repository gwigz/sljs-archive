...
class TransferInfo extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    ['transferInfo', { quantity: 1, parameters: new Collection<string, any>([['transfer', Types.UUID], ['channelType', Types.S32], ['targetType', Types.S32], ['status', Types.S32], ['size', Types.S32], ['params', Types.Variable2]]) }]
  ])
