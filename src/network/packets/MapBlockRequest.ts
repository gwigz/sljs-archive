...
class MapBlockRequest extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    ['agentData', { quantity: 1, parameters: new Collection<string, any>([['agent', Types.UUID], ['session', Types.UUID], ['flags', Types.U32], ['estate', Types.U32], ['godlike', Types.Boolean]]) }],
    // tslint:disable-next-line:max-line-length
    ['positionData', { quantity: 1, parameters: new Collection<string, any>([['minX', Types.U16], ['maxX', Types.U16], ['minY', Types.U16], ['maxY', Types.U16]]) }]
  ])
