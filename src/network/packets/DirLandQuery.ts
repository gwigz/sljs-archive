...
class DirLandQuery extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    // tslint:disable-next-line:max-line-length
    ['queryData', { quantity: 1, parameters: new Collection<string, any>([['query', Types.UUID], ['queryFlags', Types.U32], ['searchType', Types.U32], ['price', Types.S32], ['area', Types.S32], ['queryStart', Types.S32]]) }]
  ])
