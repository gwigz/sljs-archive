...
class DirPlacesQueryBackend extends Packet {
  ...
  public static format: Collection = new Collection([
    ...
    // tslint:disable-next-line:max-line-length
    ['queryData', { quantity: 1, parameters: new Collection([['query', Types.UUID], ['queryText', Types.Variable1], ['queryFlags', Types.U32], ['category', Types.S8], ['simName', Types.Variable1], ['estate', Types.U32], ['godlike', Boolean], ['queryStart', Types.S32]]) }]
  ])
