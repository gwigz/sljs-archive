...
class GroupTitlesReply extends Packet {
  ...
  static format = new Collection([
    ['agentData', { quantity: 1, parameters: new Collection([['agent', Types.UUID], ['group', Types.UUID], ['request', Types.UUID]]) }],
    ['groupData', { parameters: new Collection([['title', Types.Variable1], ['role', Types.UUID], ['selected', Boolean]]) }]
  ])
