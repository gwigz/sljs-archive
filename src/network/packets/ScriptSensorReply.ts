...
class ScriptSensorReply extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    ['requester', { quantity: 1, parameters: new Collection<string, any>([['source', Types.UUID]]) }],
    // tslint:disable-next-line:max-line-length
    ['sensedData', { parameters: new Collection<string, any>([['object', Types.UUID], ['owner', Types.UUID], ['group', Types.UUID], ['position', Types.Vector3], ['velocity', Types.Vector3], ['rotation', Types.Quaternion], ['name', Types.Variable1], ['type', Types.S32], ['range', Types.F32]]) }]
  ])
