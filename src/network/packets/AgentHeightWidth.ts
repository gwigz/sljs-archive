...
class AgentHeightWidth extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    ['agentData', { quantity: 1, parameters: new Collection<string, any>([['agent', Types.UUID], ['session', Types.UUID], ['circuitCode', Types.U32]]) }],
    // tslint:disable-next-line:max-line-length
    ['heightWidthBlock', { quantity: 1, parameters: new Collection<string, any>([['genCounter', Types.U32], ['height', Types.U16], ['width', Types.U16]]) }]
  ])
