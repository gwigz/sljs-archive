...
class GroupNoticeAdd extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    // tslint:disable-next-line:max-line-length
    ['messageBlock', { quantity: 1, parameters: new Collection<string, any>([['toGroup', Types.UUID], ['id', Types.UUID], ['dialog', Types.U8], ['fromAgentName', Types.Variable1], ['message', Types.Variable2], ['binaryBucket', Types.Variable2]]) }]
  ])
