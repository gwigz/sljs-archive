...
class GroupRoleMembersReply extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    ['agentData', { quantity: 1, parameters: new Collection<string, any>([['agent', Types.UUID], ['group', Types.UUID], ['request', Types.UUID], ['totalPairs', Types.U32]]) }],
    // tslint:disable-next-line:max-line-length
    ['memberData', { parameters: new Collection<string, any>([['role', Types.UUID], ['member', Types.UUID]]) }]
  ])
