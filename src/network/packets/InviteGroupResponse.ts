...
class InviteGroupResponse extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    ['inviteData', { quantity: 1, parameters: new Collection<string, any>([['agent', Types.UUID], ['invitee', Types.UUID], ['group', Types.UUID], ['role', Types.UUID], ['membershipFee', Types.S32]]) }]
  ])
