...
class SetStartLocation extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    ['startLocationData', { quantity: 1, parameters: new Collection<string, any>([['agent', Types.UUID], ['region', Types.UUID], ['location', Types.U32], ['regionHandle', Types.U64], ['locationPos', Types.Vector3], ['locationLookAt', Types.Vector3]]) }]
  ])
