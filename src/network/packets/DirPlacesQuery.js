...
class DirPlacesQuery extends Packet {
  ...
  static format = new Collection([
    ...
    ['queryData', { quantity: 1, parameters: new Collection([['query', Types.UUID], ['queryText', Types.Variable1], ['queryFlags', Types.U32], ['category', Types.S8], ['simName', Types.Variable1], ['queryStart', Types.S32]]) }]
  ])
