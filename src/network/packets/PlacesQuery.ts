...
class PlacesQuery extends Packet {
  ...
  public static format: Collection = new Collection([
    ...
    ['agentData', { quantity: 1, parameters: new Collection([['agent', Types.UUID], ['session', Types.UUID], ['query', Types.UUID]]) }],
    // tslint:disable-next-line:max-line-length
    ['transactionData', { quantity: 1, parameters: new Collection([['transaction', Types.UUID]]) }],
    // tslint:disable-next-line:max-line-length
    ['queryData', { quantity: 1, parameters: new Collection([['queryText', Types.Variable1], ['queryFlags', Types.U32], ['category', Types.S8], ['simName', Types.Variable1]]) }]
  ])
