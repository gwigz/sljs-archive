...
class PlacesQuery extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    ['agentData', { quantity: 1, parameters: new Collection<string, any>([['agent', Types.UUID], ['session', Types.UUID], ['query', Types.UUID]]) }],
    // tslint:disable-next-line:max-line-length
    ['transactionData', { quantity: 1, parameters: new Collection<string, any>([['transaction', Types.UUID]]) }],
    // tslint:disable-next-line:max-line-length
    ['queryData', { quantity: 1, parameters: new Collection<string, any>([['queryText', Types.Variable1], ['queryFlags', Types.U32], ['category', Types.S8], ['simName', Types.Variable1]]) }]
  ])
