...
class CreateInventoryItem extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    // tslint:disable-next-line:max-line-length
    ['inventoryBlock', { quantity: 1, parameters: new Collection<string, any>([['callback', Types.U32], ['folder', Types.UUID], ['transaction', Types.UUID], ['nextOwnerMask', Types.U32], ['type', Types.S8], ['invType', Types.S8], ['wearableType', Types.U8], ['name', Types.Variable1], ['description', Types.Variable1]]) }]
  ])
