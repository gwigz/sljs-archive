...
class LinkInventoryItem extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    // tslint:disable-next-line:max-line-length
    ['inventoryBlock', { quantity: 1, parameters: new Collection<string, any>([['callback', Types.U32], ['folder', Types.UUID], ['transaction', Types.UUID], ['oldItem', Types.UUID], ['type', Types.S8], ['invType', Types.S8], ['name', Types.Variable1], ['description', Types.Variable1]]) }]
  ])
