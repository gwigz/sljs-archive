...
class SimCrashed extends Packet {
  ...
  public static format: Collection<string, any> = new Collection([
    ...
    ['data', { quantity: 1, parameters: new Collection<string, any>([['regionX', Types.U32], ['regionY', Types.U32]]) }],
    // tslint:disable-next-line:max-line-length
    ['users', { parameters: new Collection<string, any>([['agent', Types.UUID]]) }]
  ])
